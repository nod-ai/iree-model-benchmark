...
# Usage: PATH=/path/to/iree/build/tools:$PATH ./benchmark-405b-tp8-decode.sh
...
readonly -a INPUTS=(
  "--input=@${INPUT_PATH}/next_tokens.npy"
  "--input=@${INPUT_PATH}/seq_lens.npy"
  "--input=@${INPUT_PATH}/start_positions.npy"
  "--input=@${INPUT_PATH}/seq_block_ids.npy"
  "--input=@${INPUT_PATH}/cs_f16_shard_0.npy"
  "--input=@${INPUT_PATH}/cs_f16_shard_1.npy"
  "--input=@${INPUT_PATH}/cs_f16_shard_2.npy"
  "--input=@${INPUT_PATH}/cs_f16_shard_3.npy"
  "--input=@${INPUT_PATH}/cs_f16_shard_4.npy"
  "--input=@${INPUT_PATH}/cs_f16_shard_5.npy"
  "--input=@${INPUT_PATH}/cs_f16_shard_6.npy"
...
if (( "${USE_TRACY}" == "1")); then
    ...
    "${IREE_TRACY_CAPTURE}" -f -p 8087 -o "${WORKING_DIR}/${PREFIX}.decode.405b_tp8.tracy"
else
    run_benchmark
fi
