...
# Base llama 70b-fp4 compilation script. This is intended to be invoked by other scripts.
# Usage:
# ./compile-70b-fp4-base.sh <iree-compile-path> <gfxip> <input mlir> -o <output vmfb> [extra flags]
